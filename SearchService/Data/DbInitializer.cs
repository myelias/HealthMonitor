...
public class DbInitializer
{
    public static async Task InitDb(WebApplication app)
    {
        ...
        //     // I think we need to deserialize the datetime into bson format
        //     var HeartRateDateData = JsonSerializer.Deserialize<List<HeartRateDate>>(data, option);
        //     await DB.SaveAsync(HeartRateDateData);
        // }
    }
